      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <div className="md:col-span-2 space-y-4">
            <Link
              to="/"
              className="text-2xl flex items-center gap-3 font-bold hover:text-emerald-400 transition group relative"
            >
              <motion.div
                className="relative"
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-md">
              GoWay connects riders with trusted drivers, ensuring safe, fast,
              and affordable rides. Whether commuting or exploring — GoWay takes
              you there.
            </p>
        ...
        >
          <p>&copy; {new Date().getFullYear()} GoWay. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
